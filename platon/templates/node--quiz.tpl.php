          ...
          <tr>
            ...
            <td class="take-button-cell" rowspan="<?php print $rows; ?>">
              ...
              if (node_access('update', $node,$user)) {
                ...
                print l(t("Edit lesson description"), "node/{$node->nid}/edit", array('attributes' => array('class' => array('edit', 'action-element', 'action-edit-element', 'green-link'))));
              ...
              if (!empty($link) && $link['access']) {
                ...
                print l(t("Manage lessons content"), "node/{$node->nid}/questions", array('attributes' => array('class'=> array('question', 'action-element', 'action-question-element', 'green-link'))));   
