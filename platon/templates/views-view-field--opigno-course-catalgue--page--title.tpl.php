 ...
 *          print $view->render_field('group_group', $view->row_index);
 *      } else {
 *          print $view->row_index;
 *      }
 *  ?>
 */
...
<div class="content-bottom">
  <div class="pictogram clearfix">
      <?php print $view->render_field('group_group', $view->row_index) ?>
       <div class="rate">
            <?php if($node->type == "individual_sales"){
                // print drupal_render(drupal_get_form('commerce-add-to-cart', $node->opigno_commerce_product[und][0]['product_id']));
                print drupal_render(field_view_field('node', $node, 'opigno_commerce_product'));
                }
            ?>
        </div>
  </div>
